...
(function($) {
	...
	$.extend({
		...
		pnotify: function(options) {
			...
			pnotify.container = $("<div />", {"class": styles.container+" ui-pnotify-container "+((opts.type == "error" || opts.type == "danger") ? styles.error : (opts.type == "info" ? styles.info : (opts.type == "warning" ? styles.warning : (opts.type == "success" ? styles.success : styles.notice))))})
			.appendTo(pnotify);
			if (opts.cornerclass != "")
			...
			pnotify.pnotify = function(options) {
				...
				if (opts.type != old_opts.type)
					pnotify.container.removeClass(styles.error+" "+styles.notice+" "+styles.success+" "+styles.info+" "+styles.warning).addClass((opts.type == "error" || opts.type == "danger") ? styles.error : (opts.type == "info" ? styles.info : (opts.type == "success" ? styles.success : (opts.type == "warning" ? styles.warning : styles.notice))));
				if (opts.icon !== old_opts.icon || (opts.icon === true && opts.type != old_opts.type)) {
					...
					if (opts.icon !== false) {
						...
						.append($("<span />", {"class": opts.icon === true ? ((opts.type == "error" || opts.type == "danger") ? styles.error_icon : (opts.type == "info" ? styles.info_icon : (opts.type == "warning" ? styles.warning_icon : (opts.type == "success" ? styles.success_icon : styles.notice_icon)))) : opts.icon}))
